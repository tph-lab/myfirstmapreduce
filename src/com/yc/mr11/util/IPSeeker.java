...
public class IPSeeker {
    ...
    private static final String IP_FILE = "C:\\Users\\Lenovo\\Desktop\\myfirstmapreduce\\src\\com\\yc\\mr11\\util\\data\\qqwry.dat";
    ...
    public static void main(String[] args) {
       ...
       // System.out.println(ips.getAddress(list));
        ...
        System.out.println(ips.getAddress(ip).split(" ")[0]);
        byte[] ipb= {8,8,8,8};

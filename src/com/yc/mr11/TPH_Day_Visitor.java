...
public class TPH_Day_Visitor {

    public static class KPIDayMapper extends Mapper<Object, Text,Text, Text> {
        ...
        protected void map(Object key, Text value, Context context) throws IOException, InterruptedException {
            ...
            if(kpi.isValid()){
                word.set(kpi.getRemote_addr());//IP地址
                browers.set(kpi.getTime_local().substring(0,12));//时间
                context.write(browers,word);
            }
        }
    }

    public static class KPIDayReducer extends Reducer<Text,Text,Text,Text> {
    ...
    public static void main(String[] args) throws IOException, InterruptedException, ClassNotFoundException {
        ...
        job.setMapperClass(KPIDayMapper.class);
        ...
        job.setReducerClass(KPIDayReducer.class);

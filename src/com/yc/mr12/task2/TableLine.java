...
public class TableLine {
    ...
    //连续定义
    private String imsi,position,time,timeFlag,phone;
    private Date day;
     ...
     *  * 手机号为值
     */
    public Text outKeySecond(){
        return new Text(this.position);
    }

    /**
     * 输出VALUE
     */
    public Text outValueSecond(){
        return new Text(this.phone);
    }

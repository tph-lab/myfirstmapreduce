...
public class Second extends Configured implements Tool {
    ...
    public static void main(String[] args) throws Exception {
        ...
        //运行任务
        int res= ToolRunner.run(new Configuration(),new Second(),args);
        System.exit(res);
    }
        ...
        protected void map(LongWritable key, Text value, Context context) throws IOException, InterruptedException {
            ...
            try{
                ...
                if(e.getFlag()==-1){
                    ...
                    //获取计数器
                    context.getCounter(First.Counter.OUTOFTIMESKIP).increment(1);
                }else {
                    context.getCounter(First.Counter.TiMESKIP).increment(1);
                }
                return;
            }catch (Exception e){
                context.getCounter(First.Counter.LINESKIP).increment(1);
                return;
            }
            /**
             *  * 以基站为键
             *  * 手机号为值
             */
            context.write(tableLine.outKeySecond(),tableLine.outValueSecond());
        }
    ...
    public static class Reduce extends Reducer<Text,Text, Text,Text> {
        ...
        protected void cleanup(Context context) throws IOException, InterruptedException {
            context.write(new Text(String.valueOf("基站的总数:  "+total)),new Text(String.valueOf("本运营商注册的手机号个数:  "+count.size())));
        }
    }
}
